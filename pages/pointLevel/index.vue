<template>
	<view class="window">
		...
		<view class="data_body" :style="{height: scrollHeight}">
			...
			<view v-if="currentTab == 'POINT_LEVEL_SM'">
				<point-level-sm :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
			<view v-else-if="currentTab == 'POINT_LEVEL_TF'">
				<point-level-tf :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
			<view v-else-if="currentTab == 'POINT_LEVEL_YK'">
				<point-level-yk :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
		</view>
	</view>
...
<script>
	...
	import PointLevelSm from "../../components/data-center/point-level-sm.vue"
	import PointLevelTf from "../../components/data-center/point-level-tf.vue"
	import PointLevelYk from "../../components/data-center/point-level-yk.vue"
	...
	export default {
		...
		data() {
			return {
				tabList: [
						{text:"SM",value:"POINT_LEVEL_SM"},
						{text:"TF",value:"POINT_LEVEL_TF"},
						{text:"YK",value:"POINT_LEVEL_YK"},
					], //标签头
				currentTab: 'POINT_LEVEL_SM',
