<template>
	<view class="window">
		...
		<view class="data_body" :style="{height: scrollHeight}">
			...
			<view v-if="currentTab == 'POINT_PERFORMANCE_SM'">
				<point-performance-sm :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
			<view v-else-if="currentTab == 'POINT_PERFORMANCE_TF'">
				<point-performance-tf :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
			<view v-else-if="currentTab == 'POINT_PERFORMANCE_YK'">
				<point-performance-yk :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
		</view>
	</view>
...
<script>
	...
	import PointPerformanceSm from "../../components/data-center/point-performance-sm.vue"
	import PointPerformanceTf from "../../components/data-center/point-performance-tf.vue"
	import PointPerformanceYk from "../../components/data-center/point-performance-yk.vue"
	...
	export default {
		...
		data() {
			return {
				tabList: [
						{text:"SM",value:"POINT_PERFORMANCE_SM"},
						{text:"TF",value:"POINT_PERFORMANCE_TF"},
						{text:"YK",value:"POINT_PERFORMANCE_YK"},
					], //标签头
				currentTab: 'POINT_PERFORMANCE_SM',
