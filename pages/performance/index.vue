<template>
	<view class="window">
		...
		<view class="data_body" :style="{height: scrollHeight}">
			...
			<view v-if="currentTab == 'CORP_PERFORMANCE_SM'">
				<corp-performance-sm :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
			<view v-else-if="currentTab == 'CORP_PERFORMANCE_TF'">
				<corp-performance-tf :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
			<view v-else-if="currentTab == 'CORP_PERFORMANCE_YK'">
				<corp-performance-yk :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
		</view>
	</view>
...
<script>
	...
	import CorpPerformanceSm from "../../components/data-center/corp-performance-sm.vue"
	import CorpPerformanceTf from "../../components/data-center/corp-performance-tf.vue"
	import CorpPerformanceYk from "../../components/data-center/corp-performance-yk.vue"
	...
	export default {
		...
		data() {
			return {
				tabList: [
						{text:"SM",value:"CORP_PERFORMANCE_SM"},
						{text:"TF",value:"CORP_PERFORMANCE_TF"},
						{text:"YK",value:"CORP_PERFORMANCE_YK"},
					], //标签头
				currentTab: 'CORP_PERFORMANCE_SM',
