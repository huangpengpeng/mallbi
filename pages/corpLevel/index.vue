<template>
	<view class="window">
		...
		<view class="data_body" :style="{height: scrollHeight}">
			...
			<view v-if="currentTab == 'CORP_LEVEL_SM'">
				<corp-level-sm :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
			<view v-else-if="currentTab == 'CORP_LEVEL_TF'">
				<corp-level-tf :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
			<view v-else-if="currentTab == 'CORP_LEVEL_YK'">
				<corp-level-yk :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
		</view>
	</view>
...
<script>
	...
	import CorpLevelSm from "../../components/data-center/corp-level-sm.vue"
	import CorpLevelTf from "../../components/data-center/corp-level-tf.vue"
	import CorpLevelYk from "../../components/data-center/corp-level-yk.vue"
	...
	export default {
		...
		data() {
			return {
				tabList: [
						{text:"SM",value:"CORP_LEVEL_SM"},
						{text:"TF",value:"CORP_LEVEL_TF"},
						{text:"YK",value:"CORP_LEVEL_YK"},
					], //标签头
				currentTab: 'CORP_LEVEL_SM',
