<template>
	<view class="window">
		...
		<view class="data_body" :style="{height: scrollHeight}">
			...
			<view v-if="currentTab == 'TEAM_SCORE_INFO_SM'">
				<team-score-infosm :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
			<view v-else-if="currentTab == 'TEAM_SCORE_INFO_TF'">
