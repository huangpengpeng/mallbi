<template>
	<view class="window">
		...
		<view class="data_body" :style="{height: scrollHeight}">
			...
			<view v-if="currentTab == 'PRES_PERFORMANCE_SM'">
				<pres-performance-sm :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
			<view v-else-if="currentTab == 'PRES_PERFORMANCE_TF'">
				<pres-performance-tf :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
			<view v-else-if="currentTab == 'PRES_PERFORMANCE_YK'">
				<pres-performance-yk :scrollHeight="scrollHeight" :currentTab="currentTab" :isPC="isPC"
					:isCanvas2d="isCanvas2d" />
			</view>
		</view>
	</view>
...
<script>
	...
	import PresPerformanceSm from "../../components/data-center/pres-performance-sm.vue"
	import PresPerformanceTf from "../../components/data-center/pres-performance-tf.vue"
	import PresPerformanceYk from "../../components/data-center/pres-performance-yk.vue"
	...
	export default {
		...
		data() {
			return {
				tabList: [
						{text:"SM",value:"PRES_PERFORMANCE_SM"},
						{text:"TF",value:"PRES_PERFORMANCE_TF"},
						{text:"YK",value:"PRES_PERFORMANCE_YK"},
					], //标签头
				currentTab: 'PRES_PERFORMANCE_SM',
