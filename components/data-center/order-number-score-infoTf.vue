...
<script>
	...
	export default {
		...
		mounted() {
			...
			this.DayOrderNumberScoreInfo("tf138940740527575", this.date);
			this.DayOrderNumberScoreAccount("tf138940740527575", this.date);
		...
		methods: {
			...
			dateChange2(e) {
				...
				this.DayOrderNumberScoreInfo("tf138940740527575", 	this.date2 );
			},
			// 获取年月日信息
			getDate(type) {
				const date = new Date();
